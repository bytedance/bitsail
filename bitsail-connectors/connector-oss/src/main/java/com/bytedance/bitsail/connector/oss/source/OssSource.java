...
public class OssSource implements Source<Row, OssSourceSplit, EmptyState>, ParallelismComputable {
  ...
  @Override
  public SourceReader<Row, OssSourceSplit> createReader(SourceReader.Context readerContext) {
    return new OssSourceReader(jobConf, readerContext);
  }

  @Override
  public SourceSplitCoordinator<OssSourceSplit, EmptyState> createSplitCoordinator(SourceSplitCoordinator.Context<OssSourceSplit, EmptyState> coordinatorContext) {
    return new OssSourceSplitCoordinator(coordinatorContext, jobConf);
  }

  @Override
  public BinarySerializer<OssSourceSplit> getSplitSerializer() {

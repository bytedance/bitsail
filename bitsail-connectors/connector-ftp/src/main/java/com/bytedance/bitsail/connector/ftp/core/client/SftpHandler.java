...
public class SftpHandler implements IFtpHandler {
  ...
  public SftpHandler(FtpConfig ftpConfig) {
  ...
  public boolean isDirExist(String directoryPath) {
    try {
      ...
      LOG.error(message);
      throw BitSailException.asBitSailException(FtpErrorCode.CONNECTION_ERROR, message);
    }
  }
  ...
  public InputStream getInputStream(String filePath) {
    try {
      ...
      LOG.error(message);
      throw BitSailException.asBitSailException(FtpErrorCode.CONNECTION_ERROR, message, e);
    }
  }

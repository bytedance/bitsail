...
public class Flink116ProgramTest {
  private static final Logger LOG = LoggerFactory.getLogger(Flink116ProgramTest.class);
  ...
  public void submit() throws Exception {
    ...
    UnifiedProgram unifiedProgram = new Flink116Program();
  ...
  private static BitSailConfiguration loadConf(String path) throws URISyntaxException, IOException {
    ClassLoader classLoader = Flink116ProgramTest.class.getClassLoader();

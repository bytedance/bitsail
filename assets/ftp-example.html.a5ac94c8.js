import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o,c as e,a as s,b as n,d as p,w as c,e as l,r as u}from"./app.adeb8394.js";const i={},r=s("h1",{id:"ftp-sftp-连接器示例",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#ftp-sftp-连接器示例","aria-hidden":"true"},"#"),n(" FTP/SFTP 连接器示例")],-1),d=l(`<p>下面展示了如何使用用户参数配置读取如下 CSV 格式文件。</p><ul><li>示例 CSV 数据</li></ul><div class="language-csv line-numbers-mode" data-ext="csv"><pre class="language-csv"><code><span class="token value">c1</span><span class="token punctuation">,</span><span class="token value">c2</span>

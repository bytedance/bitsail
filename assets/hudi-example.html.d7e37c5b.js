import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o,c as p,a as n,b as s,d as e,w as u,e as i,r as c}from"./app.ea0662f4.js";const l={},r=n("h1",{id:"hudi-连接器示例",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#hudi-连接器示例","aria-hidden":"true"},"#"),s(" Hudi 连接器示例")],-1),d=i(`<h2 id="hudi-读连接器" tabindex="-1"><a class="header-anchor" href="#hudi-读连接器" aria-hidden="true">#</a> Hudi 读连接器</h2><p>读取 Hudi 表的用户配置：</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>

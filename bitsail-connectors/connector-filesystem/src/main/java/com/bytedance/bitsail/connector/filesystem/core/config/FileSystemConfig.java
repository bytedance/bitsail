...
package com.bytedance.bitsail.connector.filesystem.core.config;
...
public class FileSystemConfig implements Serializable {
  ...
  public FileSystemConfig(BitSailConfiguration jobConf) {
    ...
    this.format = FileSystemConfig.Format.valueOf(jobConf.get(FileSystemReaderOptions.FORMAT).toUpperCase());

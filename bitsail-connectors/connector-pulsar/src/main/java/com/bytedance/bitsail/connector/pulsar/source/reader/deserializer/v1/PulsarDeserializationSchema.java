...
package com.bytedance.bitsail.connector.pulsar.source.reader.deserializer.v1;
...
public class PulsarDeserializationSchema implements DeserializationSchema<byte[], Row> {
  ...
  public PulsarDeserializationSchema(BitSailConfiguration deserializationConfiguration,
				     TypeInfo<?>[] typeInfos,
				     String[] fieldNames) {

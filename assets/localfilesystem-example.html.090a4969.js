import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as e,c as o,a as n,b as s,d as p,w as l,e as c,r as i}from"./app.419631c0.js";const u={},r=n("h1",{id:"localfilesystem-connector-example",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#localfilesystem-connector-example","aria-hidden":"true"},"#"),s(" LocalFileSystem connector example")],-1),d=c(`<h2 id="localfilesystem-reader" tabindex="-1"><a class="header-anchor" href="#localfilesystem-reader" aria-hidden="true">#</a> LocalFileSystem Reader</h2><p>If the file contains (id, date, localdatetime_value, last_name, bool_value) these five fields, we can use the following configuration to read.</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>

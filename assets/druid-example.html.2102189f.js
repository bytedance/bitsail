import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as p,c as o,a as n,b as s,d as e,w as u,e as c,r as l}from"./app.e5d47935.js";const i={},r=n("h1",{id:"druid-连接器示例",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#druid-连接器示例","aria-hidden":"true"},"#"),s(" Druid 连接器示例")],-1),d=c(`<h2 id="druid-写连接器" tabindex="-1"><a class="header-anchor" href="#druid-写连接器" aria-hidden="true">#</a> Druid 写连接器</h2><p>假设当前有一个测试Druid集群，其master地址为&quot;127.0.0.1:64086&quot;，则可以通过如下配置写入test_druid_datasource资料源。</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>

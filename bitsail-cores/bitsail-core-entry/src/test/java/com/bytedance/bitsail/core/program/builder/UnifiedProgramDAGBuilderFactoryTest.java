...
import com.bytedance.bitsail.core.program.impl.UnifiedProgramDAGBuilderFactory;
...
public class UnifiedProgramDAGBuilderFactoryTest {
  ...
  private UnifiedProgramDAGBuilderFactory unifiedDAGBuilderFactory;
  ...
  public void init() {
    ...
    unifiedDAGBuilderFactory = new UnifiedProgramDAGBuilderFactory();
  }

  @Test
  public void testGetDataReaderDAGBuilder() throws Exception {

    DataReaderDAGBuilder dataReaderDAGBuilder = unifiedDAGBuilderFactory.getDataReaderDAGBuilder(
  ...
  public void testGetDataReaderDAGBuilderList() {
    List<DataReaderDAGBuilder> dataReaderDAGBuilderList = unifiedDAGBuilderFactory.getDataReaderDAGBuilders(
  ...
  public void testGetDataWriterDAGBuilder() throws Exception {
    ...
    DataWriterDAGBuilder dataWriterDAGBuilder = unifiedDAGBuilderFactory.getDataWriterDAGBuilder(
        Mode.BATCH, dagBuilderConf, pluginFinder);
  ...
  public void testGetDataWriterDAGBuilderList() {
    List<DataWriterDAGBuilder> dataWriterDAGBuilderList = unifiedDAGBuilderFactory.getDataWriterDAGBuilders(
        Mode.BATCH, ImmutableList.of(dagBuilderConf, legacyPluginConf), pluginFinder);

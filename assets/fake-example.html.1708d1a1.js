import{_ as e}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as t,c as o,a as n,b as a,d as p,w as c,e as r,r as l}from"./app.fe93ffff.js";const i={},u=n("h1",{id:"fake-connector-examples",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#fake-connector-examples","aria-hidden":"true"},"#"),a(" Fake connector examples")],-1),d=r(`<hr><h2 id="fake-reader-example" tabindex="-1"><a class="header-anchor" href="#fake-reader-example" aria-hidden="true">#</a> Fake reader example</h2><p>Suppose you want to generate a data set of 300 records, and specify that each record has two fields named name and age, you can use the following configuration to read.</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>

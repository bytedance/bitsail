import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as p,c as o,a as n,b as s,d as e,w as u,e as l,r as i}from"./app.a52a4427.js";const c={},r=n("h1",{id:"kudu-连接器示例",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#kudu-连接器示例","aria-hidden":"true"},"#"),s(" Kudu 连接器示例")],-1),k=l(`<h2 id="kudu-读连接器" tabindex="-1"><a class="header-anchor" href="#kudu-读连接器" aria-hidden="true">#</a> Kudu 读连接器</h2><p>假设当前有一个测试kudu集群，其master地址为&quot;127.0.0.1:64086&quot;，则可以通过如下配置读取test_kudu_table表。</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>

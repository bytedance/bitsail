import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as p,c as o,a as n,b as s,d as e,w as u,e as c,r as l}from"./app.056e7792.js";const i={},r=n("h1",{id:"jdbc-连接器示例",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#jdbc-连接器示例","aria-hidden":"true"},"#"),s(" JDBC 连接器示例")],-1),d=c(`<h2 id="mysql-example" tabindex="-1"><a class="header-anchor" href="#mysql-example" aria-hidden="true">#</a> MySQL Example</h2><h3 id="mysql-source" tabindex="-1"><a class="header-anchor" href="#mysql-source" aria-hidden="true">#</a> MySQL source</h3><h4 id="mysql-table-sync" tabindex="-1"><a class="header-anchor" href="#mysql-table-sync" aria-hidden="true">#</a> MySQL table sync</h4><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>

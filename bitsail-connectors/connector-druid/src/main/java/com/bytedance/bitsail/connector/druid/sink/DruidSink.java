...
public class DruidSink <CommitT extends Serializable> implements Sink<Row, CommitT, EmptyState> {
  ...
  public Writer<Row, CommitT, EmptyState> createWriter(Writer.Context<EmptyState> context) throws IOException {
    return new DruidWriter<>(this.writerConf, createTypeInfoConverter());
  }
}

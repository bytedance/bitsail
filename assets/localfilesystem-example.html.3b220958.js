import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as e,c as o,a as s,b as n,d as p,w as l,e as c,r as i}from"./app.419631c0.js";const u={},r=s("h1",{id:"localfilesystem-连接器",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#localfilesystem-连接器","aria-hidden":"true"},"#"),n(" LocalFileSystem 连接器")],-1),d=c(`<h2 id="localfilesystem-读连接器" tabindex="-1"><a class="header-anchor" href="#localfilesystem-读连接器" aria-hidden="true">#</a> LocalFileSystem 读连接器</h2><p>如果文件中包含（id, date, localdatetime_value, last_name, bool_value）这五个字段，我们可以使用如下配置来读取。</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>

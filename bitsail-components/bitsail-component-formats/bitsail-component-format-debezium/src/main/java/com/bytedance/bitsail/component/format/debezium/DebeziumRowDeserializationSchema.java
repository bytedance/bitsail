...
public class DebeziumRowDeserializationSchema implements DeserializationSchema<String, Row> {
  private static final Logger LOG = LoggerFactory.getLogger(DebeziumRowDeserializationSchema.class);

  private final BitSailConfiguration jobConf;
  private final JsonConverter jsonConverter;

  public DebeziumRowDeserializationSchema(BitSailConfiguration jobConf) {

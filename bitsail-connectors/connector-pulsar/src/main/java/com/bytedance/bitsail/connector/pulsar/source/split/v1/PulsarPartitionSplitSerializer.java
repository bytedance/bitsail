...
package com.bytedance.bitsail.connector.pulsar.source.split.v1;
...
public class PulsarPartitionSplitSerializer
        implements BinarySerializer<PulsarPartitionSplit> {
    ...
    @Override
    public PulsarPartitionSplit deserialize(byte[] serialized) throws IOException {
        try (ByteArrayInputStream bais = new ByteArrayInputStream(serialized);
             DataInputStream in = new DataInputStream(bais)) {
            return deserializePulsarPartitionSplit(0, in);
        }
    }

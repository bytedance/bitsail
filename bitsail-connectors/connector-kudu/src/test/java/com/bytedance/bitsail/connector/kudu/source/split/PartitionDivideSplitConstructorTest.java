...
public class PartitionDivideSplitConstructorTest {
  ...
  Partition partition1 = new Partition(new byte[]{1}, new byte[]{4}, Lists.newArrayList());
  Partition partition2 = new Partition(new byte[]{4}, new byte[]{7}, Lists.newArrayList());

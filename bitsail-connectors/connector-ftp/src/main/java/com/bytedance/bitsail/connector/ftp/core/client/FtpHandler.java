...
public class FtpHandler implements IFtpHandler {
  ...
  public FtpHandler(FtpConfig ftpConfig) {
  ...
  public void loginFtpServer() {
    ...
    try {
      ...
      if (ftpConfig.getConnectPattern() == FtpConfig.ConnectPattern.PASV) {
        ...
        throw BitSailException.asBitSailException(FtpErrorCode.CONFIG_ERROR,
      ...
      if (!FTPReply.isPositiveCompletion(reply)) {
        ...
        throw BitSailException.asBitSailException(FtpErrorCode.CONNECTION_ERROR,
      ...
      throw BitSailException.asBitSailException(FtpErrorCode.CONNECTION_ERROR, e.getMessage(), e);
    }
  }
  ...
  public boolean isDirExist(String directoryPath) {
    ...
    try {
      ...
      throw BitSailException.asBitSailException(FtpErrorCode.CONNECTION_ERROR, String.format("Check ftp directory %s is existed failed", directoryPath), e);
    } finally {
      if (originDir != null) {
        try {
  ...
  public boolean isFileExist(String filePath) {
    ...
    try {
      ...
      throw BitSailException.asBitSailException(FtpErrorCode.CONNECTION_ERROR, String.format("Check ftp file %s is existed failed", filePath), e);
    }
    return isExitFlag;
  }
  ...
  public List<String> getFiles(String path) {
    ...
    if (isDirExist(path)) {
      ...
      try {
        ...
        throw BitSailException.asBitSailException(FtpErrorCode.CONNECTION_ERROR, String.format("Get Ftp files failed due to:", e.getMessage()), e);
      }
  ...
  public long getFilesSize(String path) {
    ...
    try {
      ...
      throw BitSailException.asBitSailException(FtpErrorCode.CONNECTION_ERROR, String.format("Get ftp files size failed due to:", e.getMessage()), e);
    }
    return ftpFileSize;
  }

...
public class JdbcRowDeserializer {
  ...
  public JdbcRowDeserializer(TypeInfo<?>[] typeInfos) {
  ...
  public Row convert(ResultSet resultSet) {
    ...
    try {
      ...
      throw BitSailException.asBitSailException(JdbcErrorCode.CONVERT_ERROR, e.getCause());
    }
    return row;
  }

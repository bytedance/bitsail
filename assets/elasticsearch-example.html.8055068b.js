import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as e,c as o,a as s,b as n,d as p,w as c,e as i,r as l}from"./app.fe93ffff.js";const u={},r=s("h1",{id:"elasticsearch-连接器示例",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#elasticsearch-连接器示例","aria-hidden":"true"},"#"),n(" Elasticsearch 连接器示例")],-1),d=i(`<p>如下展示了如何使用用户参数配置写入指定的elasticsearch索引。</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
